...
function receberProdutos() {
    return __awaiter(this, void 0, void 0, function () {
        var i, nome, precoTexto, preco, cupom;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, rl.question("Digite o nome do produto: ")];
                case 2:
                    nome = _a.sent();
                    return [4 /*yield*/, rl.question("Digite o preço do produto: ")];
                case 3:
                    precoTexto = _a.sent();
                ...
                case 4:
                    i++;
                    return [3 /*break*/, 1];
                case 5: return [4 /*yield*/, rl.question("Adicione um CUPOM de desconto: ")];
                case 6:
                    cupom = _a.sent();
                    if (cupom == "DEZ") {
                        desconto = soma * 0.9;
