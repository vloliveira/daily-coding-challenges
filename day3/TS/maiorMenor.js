        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, rl.question("Digite o ".concat(i + 1, "\u00BA n\u00FAmero: "))];
                case 2:
                    response = _a.sent();
                    num = Number(response);
                ...
                case 4:
                    rl.close;
                    console.log(numbers);
                    console.log("O maior n\u00FAmero digitado foi: ".concat(bigger, "."));
                    console.log("O menor n\u00FAmero digitado foi: ".concat(smaller, "."));
                    return [2 /*return*/];
            }
        });
    });
